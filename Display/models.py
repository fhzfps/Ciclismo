...
class Treino(models.Model):
    ...
    GraficoPot=models.CharField(max_length=10000,null=True,blank=True)
    GraficoCad=models.CharField(max_length=10000,null=True,blank=True)
    GraficoZonas=models.CharField(max_length=10000,null=True,blank=True)
